defmodule ErrlyWeb.Router do
  use ErrlyWeb, :router

  import ErrlyWeb.UserAuth
  ...
  # scope "/api", ErrlyWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:errly, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ErrlyWeb.Telemetry
